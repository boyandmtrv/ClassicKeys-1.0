...
const Create = () => {
    ...
    return (
        <div className="flex flex-col items-center w-full justify-center h-screen flex-1 px-20 text-center">
            <div className="bg-zinc-700 rounded-2xl shadow-2xl flex w-2/3 max-w-4xl">
                <div className="w-3/5 p-10">
                    ...
                    <div className="flex flex-col items-center">
                        <textarea className="text-black bg-[#D1D0C5] border-2 border-black rounded-md border-b-4 border-l-4 w-full h-80 p-2 mt-[50px] resize-none placeholder-black" type="text" placeholder="Type your words here" />
                    </div>
                    <button className="border-2 border-black rounded-md border-b-4 border-l-4 w-64 h-12 font-black px-2 mt-10 text-[#D1D0C5]">Generate random sentence</button>
                </div>
                <div className="w-2/5 bg-zinc-800 text-[#D1D0C5] rounded-tr-2xl rounded-br-2xl py-24 px-12">
                    ...
                    <div className="flex flex-col mt-11">
                        <input className="h-12 text-[#D1D0C5] border-2 border-black rounded-md border-b-4 border-l-4 bg-zinc-800 pl-2 placeholder-[#D1D0C5]" type="text" placeholder="Game name" />
                    </div>
                    <p className="mt-7">Difficulty:</p>
                    <div class="text-black text-sm font-normal justify-center flex gap-2 pt-2">
                        <button
                    ...
                    <div className="text-black text-sm font-normal justify-center flex gap gap-2 pt-2">
                        <button
                            className={`border-2 border-black text-[#D1D0C5] rounded-md border-b-4 border-l-4 font-black px-2 ${selectedTime === 15 ? 'bg-[#D1D0C5]' : ''
                                }`}
                        ...
                        <button
                            className={`border-2 border-black text-[#D1D0C5] rounded-md border-b-4 border-l-4 font-black px-2 ${selectedTime === 30 ? 'bg-[#D1D0C5]' : ''
                                }`}
                        ...
                        <button
                            className={`border-2 border-black text-[#D1D0C5] rounded-md border-b-4 border-l-4 font-black px-2 ${selectedTime === 60 ? 'bg-[#D1D0C5]' : ''
                                }`}
                    ...
                    <div className="text-[#D1D0C5] text-sm font-normal justify-center flex gap gap-2 pt-10">

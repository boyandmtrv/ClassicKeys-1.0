...
const Create = () => {
    ...
    return (
        <div className="flex flex-col  items-center w-full justify-center h-screen flex-1 px-20 text-center">
            <form
                className="backdrop-blur shadow-2xl flex w-2/3 max-w-5xl  border-2 border-black rounded-md border-b-8 border-l-8"
                ...
                <div className="w-3/5 p-10">
                    ...
                    <div className="flex flex-col items-center">
                        <textarea
                            className="text-black bg-[#D1D0C5] border-2 border-black rounded-md border-b-4 border-l-4 text-3xl w-full h-80 p-2 mt-[50px] resize-none placeholder-black scrollbar scrollbar-thumb-gray-900 scrollbar-track-[#D1D0C5]"
                            id="userText"
                            name="userText"
                            type="text"
                    ...
                    <button
                        className="border-2 border-black rounded-md border-b-4 border-l-4 w-64 h-12 font-black px-2 mt-10 text-md text-[#D1D0C5]"
                        onClick={onClickGenerateWords}>
                        Generate random words
                    </button>
                    <button
                        className="border-2 border-black rounded-md border-b-4 border-l-4 w-64 h-12 font-black px-2 mt-4 ml-4 text-md text-[#D1D0C5]"

    ...
    return (
        <div className="flex flex-col items-center w-full justify-center h-screen flex-1 px-20 text-center lg:ml-[0%] md:ml-[0%] sm:ml-[0%] min-[320px]:ml-[-25%]">
            <form
                ...
                onSubmit={createGameSubmitHandler}>
                <div className="lg:w-3/5 md:w-4/5 sm:w-3/5 p-10">
                    ...
                    <button
                        className="border-2 border-black rounded-md border-b-4 border-l-4 lg:w-64 md:w-48 sm:w-38 min-[320px]:w-24  h-12 font-black px-2 mt-10 lg:text-md md:text-sm sm:text-[10px] min-[320px]:text-[10px] text-[#D1D0C5]"
                        onClick={onClickGenerateWords}>
                        Random words
                    </button>
                    <button
                        className="border-2 border-black rounded-md border-b-4 border-l-4 lg:w-64 md:w-48 sm:w-38  min-[320px]:w-24 h-12 font-black px-2 mt-4  lg:text-md md:text-sm sm:text-[10px] min-[320px]:text-[10px] text-[#D1D0C5]"
                        onClick={onClickGenerateQuotes}>
                        Random quote
                    </button>
                </div>
                <div className="lg:w-2/5 md:w-3/5 sm:w-2/5 min-[320px]:w-[100%] bg-gradient-to-br from-zinc-800 to-zinc-900 text-[#D1D0C5] py-24 px-12">
                    ...
                    <div className="flex flex-col mt-11">
                        <input className="h-12 lg:w-full md:w-48 sm:w-32 min-[320px]:w-32 text-[#D1D0C5] border-2 border-black rounded-md border-b-4 border-l-4 bg-zinc-800 pl-2 placeholder-[#D1D0C5] lg:text-md sm:text-sm lg:ml-[0%] md:ml-[0%] sm:ml-[-50%]  min-[320px]:ml-[-25%]"
                            type="text"
                            id="title"
                            name="title"
                    ...
                    <div className="text-[#D1D0C5] lg:text-xl md:text-xl  sm:text-sm  font-normal justify-center flex gap gap-2 pt-10">
                        <button
                            ...
                            type="submit"
                            value="Create Game">
                            <span className="drop-shadow-[0_0.1px_1.1px_rgba(0,0,0,10)]">
                                Create
                            </span>
                        </button>
                        <button

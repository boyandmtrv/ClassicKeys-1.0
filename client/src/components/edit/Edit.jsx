        ...
        <div className="flex flex-col items-center w-full justify-center h-screen flex-1 px-20 text-center">
            <form
                ...
                <div className="w-3/5 p-10">
                    ...
                    <Link to={`/games`}
                        className="flex flex-col justify-center item border-2 border-black rounded-md border-b-4 border-l-4 w-24 h-12 font-black px-2 text-2xl text-[#D1D0C5] mt-8">
                        Back
                    </Link>
                </div>
                <div className="w-2/5 bg-gradient-to-br from-zinc-800 to-zinc-900 text-[#D1D0C5] py-24 px-12">
                    ...
                    <div className="flex flex-col mt-11">
                        <input
                            className="h-12 text-[#D1D0C5] border-2 border-black rounded-md border-b-4 border-l-4 bg-zinc-800 pl-2 placeholder-[#D1D0C5] text-2xl"
                            type="text"
                            id="title"
                            name="title"
                            value={game.title}

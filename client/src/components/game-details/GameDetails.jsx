        ...
        <form className="bg-zinc-700 shadow-2xl flex w-2/3 max-w-5xl  border-2 border-black rounded-md border-b-8 border-l-8">
            <div className="w-3/5 p-10">
                ...
                <div className="flex flex-col items-center">
                    <div className="text-black bg-[#D1D0C5] border-2 border-black rounded-md border-b-4 border-l-4 text-3xl w-full h-80 p-2 mt-[50px]">{game.userText}</div>
                </div>
            ...
            <div className="w-2/5 bg-zinc-800 text-[#D1D0C5] py-24 px-12">
                ...
                <div className="flex flex-col mt-11">
                    <div className="h-12 text-[#D1D0C5] border-2 border-black rounded-md border-b-4 border-l-4 bg-zinc-800 pl-2 text-2xl">{game.title}</div>
                </div>
                ...
                <div className="text-black text-2xl font-normal justify-center flex gap gap-2 pt-2">
                    <div className="border-2 bg-zinc-800 border-black text-[#D1D0C5] rounded-md border-b-4 border-l-4 font-black px-2 w-3">{game.time}</div>

...
const EndGame = ({
    ...
    const linkStyle =
        "flex flex-col items-center justify-center border-2 border-black rounded-md border-b-8 border-l-8 text-[#D1D0C5] w-48 h-16 p-2 mb-5 transition duration-300 ease-in-out transform hover:bg-amber-300 hover:text-black";
        ...
        <div className="w-full h-screen flex bg-transparent">
           <div className="lg:w-[50%] lg:h-screen md:lg:w-[50%] md:h-screen sm:w-[90%] min-[320px]:w-[90%] h-screen from-zinc-800 to-zinc-900">
                <animated.h1
                    ...
                    <div className="lg:text-3xl md:text-xl sm:text-md min-[320px]:text-sm lg:ml-[180px] md:ml-[10px] sm:ml-[30px] min-[320px]:ml-[5px] text-[#D1D0C5]">
            ...
            <div className="lg:w-[45%] md:w-[40%] sm:w-[30%] min-[320px]:w-[10%] h-screen from-zinc-800 to-zinc-900 flex flex-col justify-center items-center">
                <animated.div
                    className="w-full h-[75%] flex lg:flex-col md:flex-col sm:flex-row items-center justify-between mt-10 lg:ml-[700px] md:ml-[600px] sm:mr-[800px] min-[320px]:mr-[550px] lg:mt-[0%] md:mt-[0%] sm:mt-[200%] min-[320px]:mt-[200px] text-gray-500 lg:text-3xl md:text-2xl sm:text-2xl lg:space-y-4 md:space-y-4 sm:space-x-8 min-[320px]: space-x-4" style={statsProps}>

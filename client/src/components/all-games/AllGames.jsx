    ...
    return (
        <div className="flex flex-wrap mt-[-112px] justify-start min-h-screen flex-1 px-20 bg-zinc-800 pt-[150px] gap-10 ml-5">
            ...
            <div className="bg-zinc-700 p-10 w-[25rem] h-[22rem] border-2 border-black rounded-md border-b-8 border-l-8">
                ...
                <h2 className="font-bold text-3xl mt-2 text-[#D1D0C5]">
                ...
                <button className="bg-amber-300 text-black font-semibold py-1 px-4 text-2xl mt-7 inline-flex items-center group border-2 border-black rounded-md border-b-4 border-l-4 ">
                    Check it
                </button>
            </div>
            <div className="bg-zinc-700 p-10 w-[25rem] h-[22rem] border-2 border-black rounded-md border-b-8 border-l-8">

            ...
            <div className="w-full h-screen flex items-center justify-center mt-[-112px]">
                <div className="bg-transparent shadow p-12 border-2 border-black rounded-md border-b-8 border-l-8">
                    <div className="text-center">
                        ...
                        <p className="text-2xl pb-8 px-12 font-medium text-white">The page you are looking for does not exist.</p>
                        <Link to='/' className="border-2 border-black rounded-md border-b-8 border-l-8 bg-[#D1D0C5] text-black text-xl p-2 mb-5 transition duration-300 ease-in-out transform hover:bg-amber-300 hover:text-black">
                            Return Home
                        </Link>
                    </div>
                </div>

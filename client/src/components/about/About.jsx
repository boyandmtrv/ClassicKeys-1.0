            ...
            <div className="w-full h-screen flex justify-center items-center mt-[-112px]">
                <div className="flex space-x-8 mt-[9%] m-[7%]">
                    <div className="p-8 mb-10 border-2 bg-[#D1D0C5] border-black rounded-md border-b-8 border-l-8">
                        <div className="my-8">
                            <h1 className="text-black 2xl:text-7xl pl-12 pt-[100px] 2xl:-mt-10">About Us</h1>
                        </div>
                        <div className="-mt-6 relative">
                            <p className="text-amber-200 text-xl font-bold lg:px-9 2xl:pt-6 2xl:mx-2" style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.5)' }}>
                    ...
                    <div className="bg-zinc-700 p-8 border-2 border-black rounded-md border-b-8 border-l-8 mb-10 pt-[90px]">
                        <div className="mt-8 lg:mx-2">
                            <p className="text-amber-300 text-4xl font-semibold pt-1 px-6">Word Set and seconds</p>
                            <br />
                            <p className="text-white text-opacity-50 font-medium text-xl mt-2 px-4">By default, ClassicKeys 1.0 uses 200 words in the English language to generate its tests and the most common seconds pattern. You can change the generated set by resetting the words and easily switch the seconds—all easily accessed in the main game menu.
                            </p>
                    ...
                    <div className="bg-zinc-800 p-8 w-[19%] border-2 border-black rounded-md border-b-8 border-l-8 mb-10 pt-[90px] flex flex-col items-center justify-center">
                        <div className="mt-8 lg:mx-2 text-center">
                            <p className="text-[#D1D0C5] text-4xl font-semibold pt-4">Reach out:</p>
                            <br />
